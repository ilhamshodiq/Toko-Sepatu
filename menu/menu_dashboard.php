    ...
    <div class="d-flex bg-dark text-white" id="wrapper">
        ...
        <div class="bg-dark" id="sidebar-wrapper">
            <div class="list-group list-group-flush my-3">
                <a href="menu_dashboard.php" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-home me-2"></i>Dashboard</a>
                <a href="menu_sepatu.php" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-pills me-2"></i>Sepatu</a>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid px-4">
                <h1 class="fs-5 mb-2"><?php echo "Anda Login Admin Sebagai, aisjduoashduiashd"  ?></h1>
